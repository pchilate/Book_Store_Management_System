...
functionalities:----- 1. Create Account
                      ...
                      3. Logout
                      4. Search books
                      5. purchase books by adding into the cart first
                      6. purchase book directly without adding into the cart
                      7. order details
                      8. cancle order
                      9. Maximum sold books (for owner to figure out which book is more purchase by customers)
                      10. Minimum sold books (for owner to figure out which book is rarely purchse by customers)
                      11. Delete account
                      12. Genrate customer ID
                      13. Genrate Cart ID
                      14. Genrate OrderID
                      15. username validation
                      16. password validation
                      17. myaccount details
                      18. show my cart details
...
Packages and Module: -------- 1. mysql.connector
                              2. re (regular expresion)
                              3. random
                              4. string
                              5. datetime
